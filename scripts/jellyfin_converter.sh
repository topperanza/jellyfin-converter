...
ENV_KEYS=(PROFILE FORCE_TRANSCODE MAX_VIDEO_BITRATE_KBPS MAX_FILESIZE_MB REMUX_MAX_GB TARGET_HEIGHT CRF PRESET CODEC HW_ACCEL OVERWRITE DELETE DELETE_SIDECARS PARALLEL DRY_RUN SKIP_DELETE_CONFIRM OUTROOT LOG_DIR PRINT_SUBTITLES INCLUDE_HIDDEN)
ENV_DEFAULTS=()
