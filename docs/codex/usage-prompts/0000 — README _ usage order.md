...
Then:  
7\. \`07 — Commit _ push after pass.md\`
...
2\. \`07 — Commit _ push after pass.md\` only if release-ready changes already exist locally and still need commit/push  
3\. \`09 — Tag&Releaase.md\`
...
1\. \`000 — Full repo audit (recovery tool only).md\`
