...
description: Implement exactly one milestone-sized change per the current milestone contract
---

> Canonical source: docs/codex/usage-prompts/02-milestone-implementation.md
