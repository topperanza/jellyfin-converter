...
Goal:
Identify the next milestone-sized unit of work that moves the repository forward while preserving the current control plane, validation order, anti-loop workflow, and triple-agent compatibility.
