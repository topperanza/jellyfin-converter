---
name: blocker-closure-check
description: Narrow review to confirm named blockers are resolved and the repo can advance
---

> Canonical source: docs/codex/usage-prompts/05-blocker-closure-check.md
