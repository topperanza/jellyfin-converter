---
name: tag-release
description: Create annotated release tag and GitHub release for an approved, committed release state
disable-model-invocation: true
---

> Canonical source: docs/codex/usage-prompts/09-tag&release.md
...
- Use SemVer tag format: `vMAJOR.MINOR.PATCH` (e.g., `v0.1.0`, `v1.0.0`, `v1.3.0`). Do not create date-based tags.
