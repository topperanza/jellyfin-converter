---
name: release-prep
description: Verify release-facing truth and classify blockers vs follow-ups; determine release readiness
---

> Canonical source: docs/codex/usage-prompts/08-release-prep.md
